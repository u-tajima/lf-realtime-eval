...
for N in CPU_LOADS:
    ...
    # LF log parse
    log_file = f"log_all/log_cgroup/lf_output_cpu{N}.log"
    time_file = f"log_all/log_cgroup/lf_time_cpu{N}.log"
    mpstat_file = f"log_all/log_cgroup/lf_mpstat_cpu{N}.log"
...
plt.ylim(2.9, 3.2)
plt.title("Source Period Jitter --cgroup--")
plt.ticklabel_format(axis='y', style='plain')
plt.grid(True)
plt.savefig("log_all/log_img/source_jitter_cgroup.png")
...
plt.ylim(0, 0.015)
plt.title("Destination Latency --cgroup--")
plt.grid(True)
plt.savefig("log_all/log_img/dest_latency_cgroup.png")
...
# plt.ylim(0, 3)
plt.title("Scheduler Latency --cgroup--")
plt.grid(True)
plt.savefig("log_all/log_img/scheduler_latency_cgroup.png")
...
plt.ylim(0, 50) 
plt.title("Deadline Miss Rate --cgroup--")
plt.grid(True)
plt.savefig("log_all/log_img/deadline_miss_cgroup.png")
...
plt.ylim(0, 50)
plt.title("LF App CPU Usage --cgroup--")
plt.legend()
plt.grid(True)
plt.savefig("log_all/log_img/cpu_lf_usage_cgroup.png")
...
plt.ylabel("CPU Usage (%)")
plt.ylim(0, 110)
plt.title("PC Total CPU Usage --cgroup--")
plt.legend()
plt.grid(True)
plt.savefig("log_all/log_img/cpu_total_usage_cgroup.png")
