...
#include "include/DeadlineTest/Destination.h"
...
void _destinationreaction_function_0(void* instance_args) {
    ...
    #line 65 "/home/tajim/dev/DeadlineTest/src/DeadlineTest.lf"
    (self->count)++;
    (self->total_received)++;
...
#line 40 "/home/tajim/dev/DeadlineTest/src-gen/DeadlineTest/_destination.c"
}
void _destination_deadline_function0(void* instance_args) {
    _destination_self_t* self = (_destination_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _destination_x_t* x = self->_lf_x;
    int x_width = self->_lf_x_width; SUPPRESS_UNUSED_WARNING(x_width);
    #line 94 "/home/tajim/dev/DeadlineTest/src/DeadlineTest.lf"
    (self->deadline_miss_count)++;
    (self->count)++;
    (self->total_received)++;
...
#line 66 "/home/tajim/dev/DeadlineTest/src-gen/DeadlineTest/_destination.c"
}
